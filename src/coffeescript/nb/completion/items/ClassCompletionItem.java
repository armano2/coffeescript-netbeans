...
public class ClassCompletionItem extends IdentifierCompletionItem {
    ...
    public ClassCompletionItem(String text, String simpleText, String fileName, int startOffset, int carretOffset, int priorityDecrementor, Collection<Definition> params) {
