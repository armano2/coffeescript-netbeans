 ...
 * @author jeanmarc
 */
public class ParseAllTask implements Runnable {
...
//        Lookup lookup = Utilities.actionsGlobalContext();        
        ...
        Project p = OpenProjects.getDefault().getOpenProjects()[0];
...
//                    CoffeeScriptAntlrEditorParser.ParsingResult parseResult = (CoffeeScriptAntlrEditorParser.ParsingResult) resultIterator.getParserResult();
                }
            });
    ...
    protected Collection<FileObject> getRNGFiles() {
