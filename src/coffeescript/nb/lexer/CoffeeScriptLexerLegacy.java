...
import static coffeescript.nb.antlr.lexer.TokenEnumLexer.*;
 ...
 */
public class CoffeeScriptLexerLegacy extends CoffeeScriptLexerBase<CoffeeScriptTokenId> {
    ...
    public CoffeeScriptLexerLegacy(LexerRestartInfo<CoffeeScriptTokenId> info) {
